...
export const fetchWorkouts = () => async (dispatch) => {
  try {
    const response = await axiosInstance.get(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/workouts/`);
...
export const fetchSingleWorkout = (id) => async (dispatch) => {
  try {
    const response = await axiosInstance.get(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/workout/${id}/`);
...
export const createWorkout = (workoutData, resetForm, handleClose) => async (dispatch) => {
  ...
  try {
    const response = await axiosInstance.post(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/create/`, body);
...
export const deleteWorkout = (id) => async (dispatch) => {
  ...
  try {
    await axiosInstance.delete(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/delete/${id}/`);
  } catch (error) {
    dispatch(receiveErrors(error.message));
  }
};
...
export const updateWorkout = (workoutData, programId, updatingExercise) => async (dispatch) => {
  ...
  try {
    ...
    if (updatingExercise === true) {
      response = await axiosInstance.put(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/update-exercise/${programId}/`, body);
    } else {
      response = await axiosInstance.put(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/update/${programId}/`, body);
    }
...
export const removeExercise = (programId, ExerciseInProgramId) => async (dispatch) => {
  ...
  try {
    await axiosInstance.delete(`${process.env.REACT_APP_API_URL}/${API_BASE_URL}/delete_exercise/${programId}/${ExerciseInProgramId}/`);
